  ...
  # Main Function Code 
    ...
    htmlToText <- function(input)
    {
      ...
      ### Load the first element in the frontier to an "exploredlink" variable
           ...
           frontier <- c("http://www.cnn.com","http://www.kdnuggets.com")
           topicwords<-c("technology","analysis","web","mining","algorithm")
    ...
    group_six = data.frame(PageTitle = titleText, URL = anchor)
